...
private:
        ...
        void resolve(const FVec<SSE, float>& vz, const IVec<SSE, float>& bidx, uint32 *pr) const
    {
        ...
        IVec<SSE, float> vlem = vz < (FVec<SSE, float>)vxm;
        IVec<SSE, float> vlep = vz < (FVec<SSE, float>)vxp;
        i = i + vlem + vlep;
        i.store(pr);
    }
        ...
        void resolve(const FVec<SSE, double>& vz, const IVec<SSE, float>& bidx, uint32 *pr) const
    {
        ...
        IVec<SSE, double> vlem = vz < (FVec<SSE, double>)vxm;
        IVec<SSE, double> vlep = vz < (FVec<SSE, double>)vxp;
        i = i + vlem + vlep;
